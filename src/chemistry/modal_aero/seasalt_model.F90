...
!    seasalt_nbin = nslt
!    seasalt_nnum = nslt
!    seasalt_nbin = nslt+nslt_om
!    seasalt_nnum = nnum+nnum_om
...
!print*,'n_rog','Dg','cflx_help2'
!print*,n,Dg(i),cflx_help2(:ncol)
                if ( ( mixing_state == 0 ) .or. ( mixing_state == 2 ) ) then
                   ! Mixing state 0: external mixture, replace mass with OM,
                   !                 total number not modified
                   ! Mixing state 2: internal mixture, replace mass with OM,
                   ...
                   ! Mixing state 1: external mixture, add OM to mass and number
                   ! Mixing state 3: internal mixture, add OM to mass and number
!print*,'714om_ssa',om_ssa
!print*,'714mass_frac_bub_section', mass_frac_bub_section(:, n, i)
...
!print*,'mol_per_m3',mol_per_m3(:,1)
!print*,'theta_help',theta_help(:,1)
   do i=1,n_org_burrows
...
!print*,'mass_frac_bub_help(:, i)',mass_frac_bub_help(:, 1)
...
!print*,'mass_frac_bub_tot',mass_frac_bub_tot
!print*,'mass_frac_bub',mass_frac_bub
   do i=1,n_org_burrows
...
!print*,'mass_frac_bub_section',mass_frac_bub_section(:, i, 1)
